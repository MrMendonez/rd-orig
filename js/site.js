	...
	var s = function() {
		...
		$("nav li").on({
			...
			click: function() {
				...
				$("#sb-body-inner img#sb-player").remove();
				$('#sb-player').html('');
				var mcont = '<div id="contact-container"><h3>Contact</h3><div class="column-container clearfix"><div class="left-col"><span class="name">Ryan Decarlo</span><span class="title">Design + Creative Direction</span><span class="web">LOS ANGELES, CA 90025<br/>(TEL)  +1.518.421.0616</span></div><div class="right-col"><a href="mailto:ryandecarlo@gmail.com"><div class="contact-img"></div></a></div></div><hr/><div class="msocial"><h4>Follow Me</h4><a href="https://vimeo.com/user3129735" target="_blank"><img src="http://ryandecarlo.com/staging/images/vimeo.png"></a><a href="https://www.linkedin.com/in/ryandecarlo" target="_blank"><img src="http://ryandecarlo.com/staging/images/linkedin.png"></a><a href="https://www.behance.net/ryandecarlo" target="_blank"><img src="http://ryandecarlo.com/staging/images/be.png"></a><br/>Share<a href="mailto:ryandecarlo@gmail.com" class="share-lnk"><img class="socion" src="http://ryandecarlo.com/staging/images/share.png"></a></div>';
			...
			click: function() {
				...
				var mcont = '<div class="mwrap"><img src="'+ mimg +'" class="mimg"><div id="bfContainer" class="bioinfo"><p>' + mbio + '</p></div><hr/><div class="msocial"><h4>Follow Me</h4><a href="https://vimeo.com/user3129735" target="_blank"><img src="http://ryandecarlo.com/staging/images/vimeo.png"></a><a href="https://www.linkedin.com/in/ryandecarlo"><img src="http://ryandecarlo.com/staging/images/linkedin.png"></a><br/>Share<a href="mailto:ryandecarlo@gmail.com" class="share-lnk"><img class="socion" src="http://ryandecarlo.com/staging/images/share.png"></a></div></div>';
			...
			click: function() {
				...
				$("#sb-body-inner img#sb-player").remove();
				$('#sb-player').html('');
				var mcont = '<div class="mwrap"><div id="bfContainer" class="bioinfo"><p>This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullyin.</p><p>This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. nd functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls.This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated s both as an anti-bullying.</p><p>This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. nd functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls.This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated s both as an anti-bullying.</p><p>This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. nd functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls.This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated s both as an anti-bullying.</p><p>This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. nd functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls.This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated campaign for Secret deodorant targets teens, and functions both as an anti-bullying initiative and a brand act that positions Secret as an ally for girls. This integrated s both as an anti-bullying.</p><div class="bsocial">SHARE<a href="mailto:ryandecarlo@gmail.com" class="share-lnk"><img class="socion" src="http://ryandecarlo.com/staging/images/share.png"></a>FOLLOW<a href="https://vimeo.com/user3129735" target="_blank"><img class="socion" src="http://ryandecarlo.com/staging/images/follow.png"></a></div></div><br/><hr/><div class="sreels"><ul><li><a href="#showreels" onClick="goShowReels(1)">MOTION DESIGN REEL</a></li><li><a href="#showreels"  onClick="goShowReels(2)">INFO GRAPHICS REEL</a></li><li><a href="#showreels" onClick="goShowReels(3)">ANIMATION REEL</a></li></ul><br/><img src="http://ryandecarlo.com/staging/images/bio.jpg"><img src="http://ryandecarlo.com/staging/images/bio.jpg"><img src="http://ryandecarlo.com/staging/images/bio.jpg" class="last"></div></div>';
